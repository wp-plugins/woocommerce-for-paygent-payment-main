...
class WC_Gateway_Paygent_MCCC extends WC_Payment_Gateway {
	...
	public function __construct() {
		...
		$this->init_settings();
		$this->method_title       = __( 'Paygent Multi-currency Credit Card Payment Gateway', 'woocommerce-paygent-main2' );
		$this->method_description = __( 'Allows payments by Paygent Multi-currency Credit Card in Japan.', 'woocommerce-paygent-main2' );
       ...
       */
	    function init_form_fields() {
	      ...
	      'enabled'     => array(
	        ...
	        'label'       => __( 'Enable paygent Multi-currency Credit Card Payment', 'woocommerce-paygent-main2' ),
	        'type'        => 'checkbox',
	        'description' => '',
	        'default'     => 'no'
	        ),
	      'title'       => array(
	        ...
	        'default'     => __( 'Multi-currency Credit Card (Paygent)', 'woocommerce-paygent-main2' )
	        ),
	      'description' => array(
